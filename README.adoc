...
:figure-caption!:
:link-to-published-guide: This repository contains the source code for the guide. Visit the  https://openliberty.io/guides/{projectid}.html[Open Liberty website] for the published guide. 
[.hidden]
