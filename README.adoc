...
[role="code_command hotspot=1-37", subs="quotes"]
----
Create the `Inventory Manager` class file.
...
To achieve this by using CDI, you can simply add the [hotspot=12]`@ApplicationScoped` annotation on the class.
...
[role="code_command hotspot=14-44", subs="quotes"]
----
Create the `Inventory Resource` class file.
...
Refer to the [hotspot=14-44]`InventoryResource` class you created above.
