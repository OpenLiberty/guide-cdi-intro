...
The Open Liberty server was already started in development mode at the beginning of the guide and all the changes have been automatically picked up.
...
Since we started Open Liberty in development mode at the start of the guide, simply press `enter` to run the tests.
