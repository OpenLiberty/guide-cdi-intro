...
:page-tags: ['CDI', 'REST', '@ApplicationScoped', '@RequestScoped', '@Inject', 'MicroProfile', 'Dependency Injection']
...
has been included for you to test the basic functionality of the `inventory` service.
