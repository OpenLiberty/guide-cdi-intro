...
[source, Java]
----
include::finish/src/main/java/io/openliberty/guides/rest/inventory/InventoryManager.java[tags=**;!comment;]
----
...
[source, Java]
----
include::finish/src/main/java/io/openliberty/guides/rest/inventory/InventoryResource.java[tags=**;!comment]
----
...
[source, Java]
----
include::finish/src/main/java/io/openliberty/guides/rest/inventory/InventoryApplication.java[tags=**;!comment]
----
...
[source, Java]
----
include::finish/src/test/java/it/io/openliberty/guides/rest/EndpointTest.java[tags=testClass;!comment;!tests;!helpers]
----
