...
:page-seo-description: A getting started tutorial and an example on how to manage scopes and inject dependencies into Java microservices using Contexts and Dependency Injection (CDI).
:figure-caption!:
