...
[hotspot=properties file=0]`systemClient.getProperties()` function call.
...
Since you started Open Liberty in development mode at the start of the guide, press the `enter/return` to run the tests.
