...
:figure-caption!:
:repo-description: This repository contains the guide documentation source. To view the guide in its published form, please view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website]. 
[.hidden]
{repo-description}
