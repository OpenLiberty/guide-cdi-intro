...
You will learn how to use CDI in a simple inventory management application to manage scopes, inject dependencies(TBD: and use qualifiers).
...
This application contains two RESTful web services, the `system` and `inventory` services.
These services is provided for you.
...
The `inventory` service is similar, and is also provided for you.
...
The `system` and `Inventory` services that you will use in this guide are provided for you
...
There are detailed Javadocs that you can refer to if you learn more about the applcation
