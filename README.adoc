...
Finally, you have a client component [hotspot file=2]`SystemClient` that can be found in `src/main/java/io/openliberty/guides/inventory/client`.
...
Finally, a [hotspot=13-36 file=1]`system` test class in the [hotspot file=1]`src/test/java/it/io/openliberty/guides/system/SystemEndpointTest.java` file
