...
:page-seo-title: Managing and injecting dependencies using Contexts and Dependency Injection (CDI)
:page-seo-description: A tutorial on how to manage scopes and inject dependencies into microservices using Contexts and Dependency Injection (CDI)
:figure-caption!:
