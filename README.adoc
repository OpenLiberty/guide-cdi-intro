...
[role='command']
include::{common-includes}/twyb-intro-maven-gradle.adoc[]
...
[role='command']
include::{common-includes}/twyb-end-maven-gradle.adoc[]
...
[role='command']
include::{common-includes}/devmode-start-maven-gradle.adoc[]
